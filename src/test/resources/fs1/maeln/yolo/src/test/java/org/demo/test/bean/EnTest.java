...
public class EnTest 
{
	...
	public void testSettersAndGetters() {
		...
		System.out.println("Checking class En getters and setters ..." );
		
		En en = new En();
		
		//--- Test setter/getter for field "myfield"  ( type : String )
		// System.out.println(" checking field myfield ..." );
		en.setMyfield( stringValue ) ;
		Assert.assertTrue( stringValue.equals( en.getMyfield() ) ) ;
